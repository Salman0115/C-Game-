/*!
\file openingDoor.cpp
*/
#include "openingDoor.h"
//! constructor for the door
/*!
\ here are the functions for the door.
\ the door has joints and motors which allows it to stick together and open and close.
*/
...
openingDoor::openingDoor(b2World * world, sf::Vector2f position, float angle)
{
	...
	l_fixtureDef.friction = 0.7;
	l_fixtureDef.restitution = 1;
